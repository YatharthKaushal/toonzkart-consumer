  ...
  useEffect(() => {
    const fetchStoreDetails = async () => {
      ...
      try {
        ...
        if (response.data._id == "67f53589d83d0be7fe501ecd") {
          console.log("> is toonzkar: ");
          setIsToonzKart(true);
        }
  ...
  const updateQuantity = async (bookId, change) => {
    try {
      ...
      const cartItem = cartData.items.find(
        (item) => item.productId._id === bookId || item.productId === bookId
      );
              ...
              <div className="h-24 md:h-32 bg-gradient-to-r from-blue-500 to-indigo-600 relative">
                ...
                <div className="absolute bottom-0 left-0 w-full p-4 text-white">
                  <div className="flex items-start justify-between">
                    <h1 className="text-xl md:text-3xl font-bold drop-shadow-sm">
                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-sm md:text-base text-gray-700 mb-3">
                      {store?.description || "Books and more"}
                    </p>
                    ...
                    <div className="flex flex-col space-y-2">
                      ...
                      <div className="flex items-center text-sm text-gray-600">
                        ...
                        />
                        <span>
                          {store?.phone || "Contact store for details"}
                        </span>
                      </div>
                    </div>
                  </div>
