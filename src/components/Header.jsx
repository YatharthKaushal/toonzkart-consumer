      ...
      <div className="hidden md:flex">
        {isLoggedIn ? (
          ...
          <div className="space-x-5">
            <Link to="/login" className="text-gray-600 font-semibold">Log in</Link>
            <Link to="/signup" className="bg-blue-500 text-white px-4 py-2 rounded-lg font-semibold">
              Sign up
            </Link>
          </div>
        )}
          ...
          >
            ...
            <nav className="p-4">
              <ul className="space-y-4">
                <li>
                  <Link to="/" className="block py-2 text-gray-700 hover:text-blue-600" onClick={() => setIsMobileMenuOpen(false)}>
                    Home
                  </Link>
                </li>
                {isLoggedIn ? (
                  <>
                    <li>
                      <button onClick={goToProfile} className="w-full text-left py-2 text-gray-700 hover:text-blue-600">
                        My Profile
                      </button>
                    </li>
                    <li>
                      <Link to="/orders" className="block py-2 text-gray-700 hover:text-blue-600" onClick={() => setIsMobileMenuOpen(false)}>
                        My Orders
                      </Link>
                    </li>
                    <li>
                  ...
                  <>
                    <li>
                      <Link to="/login" className="block py-2 text-gray-700 hover:text-blue-600" onClick={() => setIsMobileMenuOpen(false)}>
                        Log in
                      </Link>
                    </li>
                    <li>
