            ...
            <ul className="hidden md:flex items-center justify-between w-full space-x-4">
              ...
              <div className="flex items-center justify-start">
                {navItems.map((item, index) => (
                  <li
                    key={index}
                    className="px-4 py-2 mx-1 cursor-pointer border-b-2 border-transparent hover:border-white transition-all duration-300 uppercase font-medium tracking-wide text-base"
            ...
            <div className="md:hidden bg-black bg-opacity-95 absolute top-16 left-0 w-full py-4 z-20">
              <ul className="flex flex-col space-y-4 px-6">
                {navItems.map((item, index) => (
                  <li
                    key={index}
                    className="cursor-pointer border-b border-transparent hover:border-white p-2 transition-all duration-200"
                    onClick={() => {
                      navigate(item.path);
